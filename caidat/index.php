...
<body>
      ...
      <div id="menu">
            ...
            <div id="listmenu">
                  ...
                  <ul>
                        ...
                        <li class="caidat"><a href="../caidat/index.php"> <i class="fa-sharp fa-solid fa-gear"></i> Cài đặt </a> </li>
                  </ul>
            </div>
            <div id="weather">
      ...
      <div class="main">
            <div class="main-left">
                  <ul>
                        <li><a href=""> <i class="fa-solid fa-language"></i>Ngôn ngữ </a> </li>
                        <li><a href=""> <i class="fa-sharp fa-solid fa-location-dot"></i>Định vị </a> </li>
                        <li><a href=""> <i class="fa-solid fa-bell"></i>Thông báo</a> </li>
                        <li><a href=""> <i class="fa-solid fa-lock"></i>Đổi mật khẩu</a></li>
                        <li><a href=""> <i class="fa-solid fa-earth-americas"></i>Phiên bản </a> </li>
                  </ul>
            </div>
