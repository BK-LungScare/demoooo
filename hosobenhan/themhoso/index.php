...
<body>
      ...
      <div id="menu">
            ...
            <div id="listmenu">
                  ...
                  <ul>
                        <li><a href="../../Frontend/index.php"> <i class="fa-sharp fa-solid fa-house"></i> Trang
                                    chủ</a>
                        </li>
                        ...
                        <li><a href="../../lienhebacsi/index.php">
                        ...
                        <li><a href="../../Kienthuccanbiet/index.php"> <i class="fa-solid fa-snowflake"></i> Kiến thức
                                    cần
                                    biết </a></li>
                        <li><a href="../../hoidap24/index.php"> <i class="fa-sharp fa-solid fa-question"></i> Hỏi đáp
                                    24/7
                              </a> </li>
                        <li><a href="../../caidat/index.php"> <i class="fa-sharp fa-solid fa-gear"></i> Cài đặt </a>
                        </li>
                  </ul>
            </div>
            <div id="weather">
      ...
      <div class="main">
            <div class="left">
                  ...
                  <div class="fix">
                        ...
                        <button name="button" type="button">Cập nhật</button>
                  </div>
            </div>
            <div class="center">
                  <form action="reg.php" method="POST" class="form">
                        <table cellpadding="0" cellspacing="8">
                              ...
                              <tr>
                                    <td>
                                          <div class="fullname">
                                                ...
                                                <input type="date" name="birth" size="100" />
                                          </div>
                                    </td>
                                    <td>
                                          <div class="city">
                              ...
                              <tr>
                                    <td>
                                          <div class="gender">
                                                <h4>Giới tính</h4>
                                                <label><input type="radio" name="rdGioiTinh" id="rdGioiTinh-1" value="1"
                                                            checked="checked"> Nam</label>
                                                <label><input type="radio" name="rdGioiTinh" id="rdGioiTinh-2"
                                                            value="2"> Nữ</label>
                                                <label><input type="radio" name="rdGioiTinh" id="rdGioiTinh-3"
                                                            value="3"> Khác</label>
                                          </div>
                                    </td>
                                    <td>
                              ...
                              <tr>
                                    <td>
                                          <div class="CCCD">
                                                <h4>Số hộ chiếu/CCCD/CMND</h4>
                                                <input type="number" name="CCCD" size="50" />
                                          </div>
                                    </td>
                                    <td>
                                          <div class="email">
                        ...
                        <input type="submit" value="Lưu thông tin" class="luuthongtin" name="btn-reg" />
                  </form>
            </div>
</body>
