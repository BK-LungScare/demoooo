...
<body>
            ...
            <div id="listmenu">
                  ...
                  <ul>
                        ...
                        <li><a href="../Kienthuccanbiet/index.php"> <i class="fa-solid fa-snowflake"></i> Kiến thức cần
                                    biết </a></li>
                        <li class="hoidap24"><a href="../hoidap24/index.php"> <i class="fa-sharp fa-solid fa-question"></i> Hỏi đáp 24/7
                              </a> </li>
      ...
      <div class="main">
            <iframe src="./chatbox/index.html" name="hello" width="1260" height="650"></iframe>
      </div>
</body>
